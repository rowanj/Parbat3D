...
class SnappingWindow
{
    ...
    static void moveSnappedWindows(RECT *newRect,RECT *oldRect,RECT *prevImageWindowRect,RECT *prevROIWindowRect,RECT *prevToolWindowRect,int moveImageWindow,int moveToolWindow,int moveROIWindow);
